...
/// It is recommended, but not essential, that this have text in common with the translation of 'else if'
Blockly.Msg.CONTROLS_CASE_MSG_CASE = 'case';
Blockly.Msg.CONTROLS_CASE_TITLE_CASE = 'case';
Blockly.Msg.CONTROLS_CASE_WHEN_TITLE_WHEN = 'when';
Blockly.Msg.CONTROLS_CASE_MSG_WHEN = 'when';

Blockly.Msg.CONTROLS_CASE_OTHERS_TITLE_OTHERS = 'others';
Blockly.Msg.CONTROLS_CASE_MSG_OTHERS = 'others';
