...
//				alert("function " + funcarray[m])
			...
			code= res[0] + "function "+ funcarray[m].split("(")[0] + "_" + rescntr + "(latchstr, bypass){\n" + "var " + funcname + "_" + rescntr + " = " + "{val:false, pre:\'\', data:\'\', wave:\'\', type:\'\', name:\'" + funcname + "_" + rescntr + "\'};\n" + res[1]
//			alert(res[0])
//			alert(res[1])
			code=code.replace(funcarray[n].split("(")[0] + '(\"\", false)', "")
			rescntr=rescntr+1
			}
			code=code.replace("function " + funcarray[m], "function "+ funcarray[m].split("(")[0] + "_" + rescntr + "(latchstr, bypass){")
			var res = code.split("function "+ funcarray[m].split("(")[0] + "_" + rescntr + "(latchstr, bypass){");
//			alert(res[0])
//			alert(res[1])
			code=code.replace(funcarray[n].split("(")[0] + '(\"\", false)', "")
