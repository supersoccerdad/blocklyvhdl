...
Blockly.Blocks['stdlogicvector'] = {
  init: function() {
    this.appendValueInput("Msb")
        .setCheck("Number")
        .appendField("StdLogicVector");
...
Blockly.Blocks['stdlogic'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("StdLogic");
...
Blockly.Blocks['signalname'] = {
  init: function() {
    this.appendValueInput("signalname")
        .setCheck(["in", "out"])
        .appendField(new Blockly.FieldTextInput("signalname"), "signalname");
    this.setInputsInline(false);
    this.setPreviousStatement(true, "signalname");
    this.setNextStatement(true, "signalname");
    this.setColour(45);
    this.setTooltip('');
    this.setHelpUrl('http://www.example.com/');
  }
...
Blockly.Blocks['port'] = {
  init: function() {
    this.appendStatementInput("Port")
        .setCheck(["signalname"])
        .appendField("Port");
...
Blockly.Blocks['function'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Entity")
        .appendField(new Blockly.FieldTextInput("default"), "EntityName");
    this.appendStatementInput("NAME")
        .setCheck(null)
        .appendField("Port");
    this.appendDummyInput()
        .appendField("Architecture")
        .appendField(new Blockly.FieldTextInput("default"), "ArchitectureName");
    this.appendStatementInput("NAME")
        .setCheck(null)
        .appendField("Begin");
    this.setColour(20);
